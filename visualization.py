...
st.header(f'Heatmaps Showing the Correlation Between the Apps {app1}, {app2} And Usage and Users Religious Affiliation')
...
st.header(f'Pie Charts Showing Family Status of Users in {app_1}, {app_2}')
